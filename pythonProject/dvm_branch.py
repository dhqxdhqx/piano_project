...
def practice_screen():
    ...
    user_options = tk.Label(user_frame, text=username, font=("Raleway",20), fg="black", height=2, width=15, cursor='hand2')
    user_options.pack()
    ...
    def user_menu():
        ...
        logout_btn = tk.Button(user_menu_window, text="Log Out", command=lambda:logout(), font="Raleway", bg="#275D38", fg="white", height=2, width=15)
        logout_btn.pack()
